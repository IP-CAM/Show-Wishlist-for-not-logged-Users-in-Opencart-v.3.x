 ...
 */
require_once DIR_SYSTEM . "/library/jus/AccountWishlistInterface.php";
 ...
 */
final class ModelExtensionModuleJusWishlist extends Model implements AccountWishlistInterface
{
    /**
     * Cntr
